...
export const fetchCrossingData = async () => {
    ...
    parser.parseString( data, (err, result) => {
      ...
      const crossingData = result;
      const CanadianBorders = [];
      const MexicanBorders = [];
      for (const item in crossingData.border_wait_time.port) {
        const thisBorder = crossingData.border_wait_time.port[item];
